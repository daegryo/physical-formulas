...
class Mkt1(QMainWindow):
    def __init__(self):
       ...
       # self.theoryButton.clicked.connect(self.theory)
        ...
        self.result = self.cur.execute(f"""SELECT * FROM mkt1
                                                               WHERE number= '{7}'""").fetchall()
        st = '<br>'
        note = []
        ...
        image_path = f"images/practise/mkt/{self.result[0][4]}"
    ...
    def sh(self):
        ...
        if self.parameter == "Задание 7":
            self.num = 7
        elif self.parameter == "Задание 8":
            self.num = 8
        elif self.parameter == "Задание 9":
            self.num = 9
        elif self.parameter == "Задание 10":
            self.num = 10
        elif self.parameter == "Задание 21":
            self.num = 21
        elif self.parameter == "Задание 23":
            self.num = 23
        elif self.parameter == "Задание 24":
            self.num = 24
        self.result = self.cur.execute(f"""SELECT * FROM mkt1
    ...
    def next(self):
        ...
        if self.count < self.counter and self.flag:
            ...
            if self.count + 1 <= len(self.result):
                self.numLabel.setText(f"{self.count + 1}/{len(self.result)}")
            image_path = f"images/practise/mkt/{self.result[self.count][4]}"
