...
class El(QMainWindow):
    def __init__(self):
        super().__init__()
        uic.loadUi('el.ui', self)
        ...
        self.result = self.cur.execute(f"""SELECT * FROM el
        ...
        with open(f"theory/el/1.txt", 'r', encoding='utf-8') as file:
            text = file.read()
            self.textLabel.setText(text)
            self.textLabel.setStyleSheet(
                """font: 13pt "Palatino Linotype";""")
            self.textLabel.setTextFormat(Qt.RichText)
        self.pixmap_formulas = QPixmap(f"images/theory/el/1/0.png")
    ...
    def speak_current_text_streaming(self):
            ...
            with open(f"theory/speak/el/{self.result[2]}.txt", 'r', encoding='utf-8') as file:
                text = file.read()
    ...
    def sh(self):
        ...
        with open(f"theory/el/{self.result[1]}", 'r', encoding='utf-8') as file:
            text = file.read()
            self.textLabel.setText(text)
            self.textLabel.setStyleSheet(
                """font: 13pt "Palatino Linotype";""")
        self.pixmap_formulas = QPixmap(f"images/theory/el/{self.result[2]}/{self.count}.png")
        self.photoLabel.setPixmap(self.pixmap_formulas)
        self.photoLabel.setScaledContents(True)
